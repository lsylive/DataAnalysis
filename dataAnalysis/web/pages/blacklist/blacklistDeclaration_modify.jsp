...
<head> 
	...
	function goSubmit(){
		...
		if(!checkString(getElement('record(indValues)'),"名单值",120,true)) return;
  ...
  <html:hidden property="action" />
		<table id="tblForm" cellpadding="0" cellspacing="0" width="100%" class="formTable">
			...
			<tr>
			 ...
			 <tr>
						<td>
							<font color="red">*</font>对比指标：
						</td>
						<td colspan="3">
						<html:select property="record(indCode)">
							<html:optionsCollection property="codeSets(indIds)" label="codeName" value="value" />
						</html:select>
						</td>
					</tr>
			<tr>
			   <td><font color="red">*</font>名单（名单之间用半角分号隔开,每个名单的不同指标值用半角逗号隔开）:</td>
				 <td colspan="3">
					  <html:textarea rows="8" property="record(indValues)" ></html:textarea>
				 </td>
			</tr>
			<tr>
			   <td>备注：</td>
