  	...
  	<html:hidden property="record(orgId)" />
		...
		<table id="tblForm" cellpadding="0" cellspacing="0" width="100%" class="formTable">
			 ...
			 <tr>
				  ...
				  <td >
					   <html:password property="record(userPassword)" />
				  </td>
				  <td class="textR"><font color="red">*</font>确认密码：</td>
					<td>
					   <html:password property="record(confirmPassword)" />
					</td>
			 </tr>
			 <tr>
				  <td  class="textR"><font color="red">*</font>行政等级：</td>
				  <td class="sel">
				  ...
				  <td class="textR"><font color="red">*</font>用户状态：</td>
					<td class="sel">
