...
<body onload="showMessage('<bean:write name="standardIndicatorForm" property="errorMessage" />')">
<div class="special-padding"> 
<html:form action="/datastandard/indicator.do" method="post">
...
<gw:grid2 cellPadding="0" cellSpacing="0" width="100%" styleClass="listTable"
		name="standardIndicatorForm" property="query.recordSet" parameters="query" rowEventHandle="false"
		fixRows="true" >
	...
	<column width="15%" name="英文名" property="NAME" />
	<column width="20%" name="中文名" property="CNNAME" />
	<column width="12%" name="代码" property="INDICATORCODE" align="center" />
	<column width="38%" name="备注" property="REMARK" align="center" />
