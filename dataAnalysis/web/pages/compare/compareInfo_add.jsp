...
function init(){
	parent.tabbar.removeTab("a2");
	parent.tabbar.removeTab("a3");
}
</script>
  ...
  <html:hidden property="action" />
		...
		<!-- 
			  <td ><font color="red">*</font>对比类型：</td>
					<td>
					   <html:select property="record(compareType)" value="0" onchange="setTypeControls(this)" disabled="false">
			  ...
			  <td>时间点配置:</td>
					...
					<div id="daydiv">
						...
						<table cellpadding="0" cellspacing="0">
							<tr>
							<td width="50%">
							周:<html:select property="record(runDay)" disabled="true">
							...
							<td> 日:<html:text property="record(runDate)" value="1" disabled="true"/>
							</td>
							<td> 时:<html:text property="record(runHour)" value="2"></html:text>
							<td> 分:<html:text property="record(runMinute)" value="0"></html:text>	
