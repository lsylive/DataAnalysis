...
public class OperateNodeDirectEditManager extends DirectEditManager {

    Font scaledFont;

    protected VerifyListener verifyListener;

    protected OperateNodeFigure nodeFigure;
     ...
     */
    public OperateNodeDirectEditManager(GraphicalEditPart source, Class editorType, CellEditorLocator locator) {
        super(source, editorType, locator);
        //    	this.nodeFigure = nodeFigure;
        this.nodeFigure = (OperateNodeFigure) source.getFigure();
    }
...
//    }
    ...
    protected void initCellEditor() {
        ...
        getCellEditor().setValue(((OperateNode) getEditPart().getModel()).getName());
