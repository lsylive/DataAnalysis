...
public class RealNodeDirectEditManager extends DirectEditManager {
     ...
     */
    public RealNodeDirectEditManager(GraphicalEditPart source, Class editorType, CellEditorLocator locator) {
...
//    }
    ...
    protected void initCellEditor() {
        ...
        getCellEditor().setValue(((INode) getEditPart().getModel()).getName());
