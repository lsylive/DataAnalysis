...
public class UnionNodeDialog extends Dialog {

   protected int                   result;
   protected Shell                 shell;
   private UnionNode               node;
    ...
    * @param style
    */
   public UnionNodeDialog(Shell parent, int style) {
      super(parent, style);
      setText("交集转换");
   }

   public UnionNodeDialog(Shell parent, UnionNode node, NodePropertyEditCommand cmd) {
   ...
   private void createContents() {
      ...
      fd_btnCancel.left = new FormAttachment(btnOk, 45);
      ...
      fd_btnOk.right = new FormAttachment(100, -304);
