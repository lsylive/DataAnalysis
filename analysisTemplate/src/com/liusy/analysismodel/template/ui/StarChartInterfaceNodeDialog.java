...
public class StarChartInterfaceNodeDialog extends Dialog {
   ...
   private StarChartInterfaceProperties nodeProperties;
   private StarChartInterfaceNode       node;
    ...
    * @param style
    */
   public StarChartInterfaceNodeDialog(Shell parent, int style) {
      super(parent, style);
   }
    ...
    * @param parent
    */
   public StarChartInterfaceNodeDialog(Shell parent, StarChartInterfaceNode node, NodePropertyEditCommand command) {
   ...
   protected void createContents() {
      ...
      fd_label_5.left = new FormAttachment(cboLinkField, 0);
   ...
   private void setCombos() {
      ...
      if (nodeProperties.getChartConfig().containsKey("linkField")) {
         setComboValue(cbvLinkField, list, nodeProperties.getChartConfig().get("linkField"));
      }
      else {
         setComboValue(cbvLinkField, list, "");
      }
   }
   ...
   private void save() {
      ...
      nodeProperties.getChartConfig().put("linkField", getComboValue(cbvLinkField));
...
//
//         DetailLinkDialog gcd = new DetailLinkDialog(cellEditorWindow.getShell(), dlf, configList, diagram.getNodes());
