...
public class ConnectedConditionsExpressionDialog extends Dialog {

   private StyledText txtExpression;
   protected Shell    shell;
   private String     expression;

   public ConnectedConditionsExpressionDialog(Shell parent, int style) {
      super(parent, style);
   }

   public ConnectedConditionsExpressionDialog(Shell parent, String expression) {
