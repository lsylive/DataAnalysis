...
public class FilterNodeDialog extends Dialog {
   ...
   private FilterProperties        nodeProperties;
    ...
    * @param style
    */
   public FilterNodeDialog(Shell parent, int style) {
      super(parent, style);
   }
    ...
    * @param parent
    */
   public FilterNodeDialog(Shell parent, FilterNode node, NodePropertyEditCommand command) {
   ...
   private void init() {
      ...
      txtExpress.setText(node.getExpression());
   ...
   private void save() {
      ...
      node.setExpression(txtExpress.getText().trim());
