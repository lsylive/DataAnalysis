...
import com.liusy.analysismodel.log.dao.LogAudioSql;
import com.liusy.analysismodel.log.dao.formBean.LogOperateBean;
import com.liusy.analysismodel.log.listener.UserAudioLogListener;
...
import com.liusy.analysismodel.log.view.labelProvider.UserAudioLogViewLabelProvider;
...
public class UserAudioLogView extends ViewPart {
	...
	private LogAudioSql			sqlBuilder;
	private Vector<ImportLog2>	logList;
	public static final String	ID				= "DataAdminPlatform.log.view.UserAudioLogView";
	private int						x				= 0, y = 0;
	...
	public class FocusListioner extends FocusAdapter {
		...
		public void focusLost(FocusEvent focusevent) {
			if (!userAcount.getText().trim().equals(userAcountHd) || !userName.getText().trim().equals(userNameHd) || !deptNameCombo.getText().trim().equals(depNameHd)
	...
	public void createPartControl(Composite parent) {
		...
		startDateBtn.setImage(SWTResourceManager.getImage(UserAudioLogView.class, "/com/thunisoft/dataplatform/template/image/data.png"));
		...
		endDateBtn.setImage(SWTResourceManager.getImage(UserAudioLogView.class, "/com/thunisoft/dataplatform/template/image/data.png"));
		...
		viewer.setLabelProvider(new UserAudioLogViewLabelProvider());
		...
		final TableColumn newColumnTableColumn_3 = new TableColumn(table_1, SWT.NONE);
		newColumnTableColumn_3.setAlignment(SWT.CENTER);
		newColumnTableColumn_3.setWidth(150);
		newColumnTableColumn_3.setText("登录时间");

		final TableColumn newColumnTableColumn_12 = new TableColumn(table_1, SWT.NONE);
		newColumnTableColumn_12.setAlignment(SWT.CENTER);
		newColumnTableColumn_12.setWidth(90);
		newColumnTableColumn_12.setText("IP地址");
		...
		newColumnTableColumn_5.setText("登出时间");

		final TableColumn newColumnTableColumn_13 = new TableColumn(table_1, SWT.NONE);
		newColumnTableColumn_13.setAlignment(SWT.CENTER);
		newColumnTableColumn_13.setWidth(100);
		newColumnTableColumn_13.setText("登陆结果");
		...
		newColumnTableColumn_1.setText("数据来源");
		...
		searchAction = new Action() {
			public void run() {
				try {
					...
					List<ImportLog2> logonList = logProvider.selectLogTableInfo(serachSql);
					logList.clear();
			...
			public void run() {
				try {
					...
					if (logonList != null && !logonList.isEmpty()) {
						...
						pageBean.setCurrentPage(Integer.valueOf(oldPageNum));
	...
	public void addListener() {
		UserAudioLogListener listener = new UserAudioLogListener(this);
