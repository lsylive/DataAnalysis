...
public class ApplayLogListener {
	private ApplayLogView viewPart;
	public ApplayLogListener(ApplayLogView viewPart) {
		super();
	...
	public void addListener() {
		viewPart.getViewer().addDoubleClickListener(new IDoubleClickListener () {
			public void doubleClick(DoubleClickEvent doubleclickevent) {
				...
				LogOperate logBean = (LogOperate) obj.getFirstElement();
				if (logBean != null) {
					ApllyLogDetailDlg dlg = new ApllyLogDetailDlg(viewPart.getShell());
					ApplyLogDetailListener applyLogDetialDlg = new ApplyLogDetailListener(dlg,logBean);
