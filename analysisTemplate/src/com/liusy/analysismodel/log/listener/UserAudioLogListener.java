...
public class UserAudioLogListener {
	private UserAudioLogView viewPart;
	public UserAudioLogListener(UserAudioLogView viewPart) {
		super();
	...
	public void addListener() {
		viewPart.getViewer().addDoubleClickListener(new IDoubleClickListener () {
			public void doubleClick(DoubleClickEvent doubleclickevent) {
				...
				ImportLog2 logBean = (ImportLog2) obj.getFirstElement();
				if (logBean != null) {
					UserAudioLogDetailDlg dlg = new UserAudioLogDetailDlg(viewPart.getShell());
					UserAudioLogDetailListener applyLogDetialDlg = new UserAudioLogDetailListener(dlg,logBean);
		...
		viewPart.setLogonBean(new LogOperateBean(viewPart.getUserAcount(),viewPart.getUserName(),viewPart.getDeptNameCombo(),viewPart.getOrgNameCombo(),viewPart.getStartDate(),viewPart.getEndDate()));
		//查询按钮
